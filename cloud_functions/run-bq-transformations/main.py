    ...
    try:
        ...
        job_config_r2b = bigquery.QueryJobConfig(
            query_parameters=[
                ...
                bigquery.ScalarQueryParameter("raw_table", "STRING", BQ_TABLE_TRANSACTIONS),
                bigquery.ScalarQueryParameter("bronze_table", "STRING", BQ_TABLE_TRANSACTIONS),
            ]
        )
        execute_transformation('queries/01_raw_to_bronze.sql', job_config_r2b)
        ...
        execute_transformation('queries/02_bronze_to_silver.sql', job_config_b2s)
        ...
        execute_transformation('queries/03_silver_to_gold.sql', job_config_s2g)
